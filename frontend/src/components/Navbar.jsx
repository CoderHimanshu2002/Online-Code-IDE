...
const Navbar = ({ isGridLayout, setIsGridLayout }) => {
	...
	return (
		<>
			<div className="navbar flex items-center justify-between px-[100px] h-[80px] bg-[#262435]">
				<div className="logo">
					<img
				...
				<div className="links flex items-center gap-4">
					...
					<button
						onClick={logout}
						className="btnBlue !bg-red-400 min-w-[80px] ml-2 hover:!bg-red-500"
					>
						Log out
					</button>
					<Avatar
				...
				<div className="dropDownNavbar hidden absolute right-[60px] top-[80px] shadow-lg shadow-black/50 p-[10px] rounded-lg bg-[#1A1919] w-[150px] h-[130px]">
