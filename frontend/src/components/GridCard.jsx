...
const GridCard = ({item}) => {
  ...
  return (
		<>
			<div className="gridCard bg-[#2c3166] w-[270px] p-[10px] h-[180px] cursor-pointer hover:bg-[#22376d] rounded-lg shadow-lg shadow-black/50">
				<div
					onClick={() => {
				...
				<div className="model fixed top-0 left-0 w-screen h-screen bg-[rgba(0,0,0,0.1)] flex justify-center items-center flex-col">
					<div className="mainModel w-[30vw] h-[30vh] bg-[#141414] rounded-lg p-[20px]">
						...
						<div className="flex w-full mt-5 items-center gap-[10px]">
							<button className="p-[10px] rounded-lg !bg-red-400 hover:!bg-red-500 text-white cursor-pointer min-w-[49%]">
								Delete
							</button>
							<button
								onClick={() => {
