    ...
    <>
      <div className="container w-screen min-h-screen flex items-center justify-between pl-[100px]">
        <div className="left w-[35%]">
          <img className='w-[400px] h-[150px] border-4 border-indigo-400 rounded-lg' src={logo} alt="" />
          <form onSubmit={submitForm} className='w-full mt-[40px]' action="">
            ...
            <button className="bg-[rgb(52,102,204)] w-full mt-[20px] pt-2 pb-3 rounded-lg hover:bg-blue-500">Sign Up</button>
          </form>
        </div>
