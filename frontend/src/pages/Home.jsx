		...
		<>
			...
			<div className="flex items-center justify-between px-[100px] my-[40px]">
				...
				<div className="flex items-center gap-1">
					{/* Search Bar */}
					<div className="inputBox !w-[350px] rounded-[20px]">
						<input
							type="text"
					...
					<button
						...
						className="border-indigo-400 border-2 bg-[rgb(52,102,204)] rounded-[5px] hover:bg-blue-500 ml-2 mb-4 text-[20px] !p-[5px] !px-[10px]"
					>
						Create
					</button>
				</div>
			...
			{isCreateModelShow && (
				<div className="createModelCon fixed top-0 left-0 right-0 bottom-0 w-screen h-screen bg-[rgb(0,0,0,0.1)] flex items-center justify-center">
					<div className="createModel w-[25vw] h-[33vh] shadow-lg shadow-black/50 bg-[#141414] rounded-[10px] p-[20px]">
						<h3 className="text-2xl">Create New Project</h3>
						<div className="inputBox !bg-[#0c0c0c] mt-4">
							<input
								onChange={(e) => {
						...
						<div className="flex items-center gap-[10px] w-full mt-2">
							<button
								onClick={createProj}
								className="bg-[rgb(52,102,204)] hover:bg-blue-500 rounded-[5px] w-[49%] mb-4 !p-[5px] !px-[10px] !py-[10px]"
							>
								Create
							</button>
							<button
