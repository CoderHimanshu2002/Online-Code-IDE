...
const ListCard = ({ item }) => {
	...
	return (
		<>
			<div className="listCard mb-2 w-[full] flex items-center justify-between p-[10px] bg-[#2c3166] cursor-pointer rounded-lg hover:bg-[#22376d]">
				<div
					onClick={() => {
					...
					<div className="mainModel w-[30vw] h-[30vh] bg-[#141414] rounded-lg p-[20px]">
						...
						<div className="flex w-full mt-5 items-center gap-[10px]">
							<button
								...
								className="p-[10px] rounded-lg !bg-red-400 hover:!bg-red-500 text-white cursor-pointer min-w-[49%]"
							>
								Delete
							</button>
							<button
